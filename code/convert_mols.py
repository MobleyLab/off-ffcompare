"""
This script provides functions for converting molecule objects between toolkits.
Currently there are two functions:

oemol_from_rdmol: takes in an RDKit molecule and returns an OpenEye OEMol
rdmol_from_oemol: takes an OpenEye OEMol and returns an identical RDKit Mol
"""
